...
var item = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4527__auto__,i__34970);
cljs.core.chunk_append(b__34971,cljs.core.with_meta(new cljs.core.PersistentVector(null, 18, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_default,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,((function (i__34970,item,c__4527__auto__,size__4528__auto__,b__34971,s__34969__$2,temp__5735__auto__){
return (function (){
...
});})(i__34970,item,c__4527__auto__,size__4528__auto__,b__34971,s__34969__$2,temp__5735__auto__))
...
return cljs.core.chunk_cons(cljs.core.chunk(b__34971),samurai_test_task$core$lister_$_iter__34968(cljs.core.chunk_rest(s__34969__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__34971),null);
}
} else {
var item = cljs.core.first(s__34969__$2);
return cljs.core.cons(cljs.core.with_meta(new cljs.core.PersistentVector(null, 18, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$li,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_default,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,((function (item,s__34969__$2,temp__5735__auto__){
return (function (){
return ajax.core.DELETE(["/patient/",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.cst$kw$policy_number.cljs$core$IFn$_invoke$arity$1(item))].join(''));
});})(item,s__34969__$2,temp__5735__auto__))
], null),"delete"], null),new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$button$btn$btn_DASH_default,new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$on_DASH_click,((function (item,s__34969__$2,temp__5735__auto__){
return (function (){
return reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [samurai_test_task.core.update_form,item], null),document.getElementById("app"));
});})(item,s__34969__$2,temp__5735__auto__))
], null),"update"], null),"  Name - ",cljs.core.cst$kw$first_name.cljs$core$IFn$_invoke$arity$1(item),", Surname - ",cljs.core.cst$kw$last_name.cljs$core$IFn$_invoke$arity$1(item),", Father name - ",cljs.core.cst$kw$father_name.cljs$core$IFn$_invoke$arity$1(item),", Born date - ",cljs.core.cst$kw$born_date.cljs$core$IFn$_invoke$arity$1(item),", Sex - ",cljs.core.cst$kw$sex.cljs$core$IFn$_invoke$arity$1(item),", Address - ",cljs.core.cst$kw$address.cljs$core$IFn$_invoke$arity$1(item),", Policy number - ",cljs.core.cst$kw$policy_number.cljs$core$IFn$_invoke$arity$1(item),"  "], null),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$policy_number,item], null)),samurai_test_task$core$lister_$_iter__34968(cljs.core.rest(s__34969__$2)));
}
} else {
return null;
}
...
var year = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34974__$1,cljs.core.cst$kw$year);
var month = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34974__$1,cljs.core.cst$kw$month);
var day = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__34974__$1,cljs.core.cst$kw$day);
...
reagent.dom.render.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [samurai_test_task.core.lister_user], null),document.getElementById("app"));
