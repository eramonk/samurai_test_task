...
ajax.simple.base_handler = (function ajax$simple$base_handler(interceptors,p__5934){
var map__5935 = p__5934;
var map__5935__$1 = (((((!((map__5935 == null))))?(((((map__5935.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5935.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5935):map__5935);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5935__$1,cljs.core.cst$kw$handler);
...
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(cljs.core.update.cljs$core$IFn$_invoke$arity$3(request,cljs.core.cst$kw$method,ajax.simple.normalize_method),cljs.core.cst$kw$interceptors,(function (p1__5937_SHARP_){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [response_format], null),(function (){var or__4126__auto__ = p1__5937_SHARP_;
...
ajax.simple.raw_ajax_request = (function ajax$simple$raw_ajax_request(p__5938){
var map__5939 = p__5938;
var map__5939__$1 = (((((!((map__5939 == null))))?(((((map__5939.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__5939.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__5939):map__5939);
var request = map__5939__$1;
var interceptors = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__5939__$1,cljs.core.cst$kw$interceptors);
