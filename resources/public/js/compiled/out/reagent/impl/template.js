...
var G__39580 = o;
goog.object.set(G__39580,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__39581__delegate = function (args){
...
while (G__39582__i < G__39582__a.length) {G__39582__a[G__39582__i] = arguments[G__39582__i + 0]; ++G__39582__i;}
  args = new cljs.core.IndexedSeq(G__39582__a,0,null);
} 
return G__39581__delegate.call(this,args);};
G__39581.cljs$lang$maxFixedArity = 0;
G__39581.cljs$lang$applyTo = (function (arglist__39583){
var args = cljs.core.seq(arglist__39583);
return G__39581__delegate(args);
});
...
var G__39584 = o;
goog.object.set(G__39584,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__39588 = props;
var G__39588__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39588,cljs.core.cst$kw$id,id):G__39588);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39588__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__39589 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__39589,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__39589;
}
})(),id_class);
...
var G__39590 = (cljs.core.count(argv) - first_child);
switch (G__39590) {
case (0):
...
break;
case (1):
var G__39591 = component;
var G__39592 = jsprops;
var G__39593 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__39591,G__39592,G__39593);
...
var vec__39595 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39595,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39595,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39595,(2),null);
...
var temp__5739__auto___39598 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39598 == null)){
} else {
var key_39599 = temp__5739__auto___39598;
(jsprops.key = key_39599);
}
...
var temp__5739__auto___39602 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___39602 == null)){
} else {
var key_39603 = temp__5739__auto___39602;
(jsprops.key = key_39603);
}

var G__39600 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__39601 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__39600,G__39601);
});
/**
...
var temp__5739__auto___39604 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___39604 == null)){
} else {
var key_39605 = temp__5739__auto___39604;
(jsprops.key = key_39605);
}
...
var temp__5739__auto___39606 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39606 == null)){
} else {
var key_39607 = temp__5739__auto___39606;
(jsprops.key = key_39607);
}
...
var temp__5739__auto___39608 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___39608 == null)){
} else {
var key_39609 = temp__5739__auto___39608;
(jsprops.key = key_39609);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__39610_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__39610_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__39611 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39611,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__39611,(1),null);
...
break;
default:
var G__39616 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__39617 = compiler;
v = G__39616;
compiler = G__39617;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template39621 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template39621 = (function (opts,id,fn_to_element,meta39622){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template39621.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_39623,meta39622__$1){
var self__ = this;
var _39623__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template39621(self__.opts,self__.id,self__.fn_to_element,meta39622__$1));
}));

(reagent.impl.template.t_reagent$impl$template39621.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_39623){
var self__ = this;
var _39623__$1 = this;
return self__.meta39622;
}));

(reagent.impl.template.t_reagent$impl$template39621.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template39621.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template39621.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template39621.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template39621.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta39622], null);
}));

(reagent.impl.template.t_reagent$impl$template39621.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template39621.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template39621");

(reagent.impl.template.t_reagent$impl$template39621.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template39621");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template39621.
 */
reagent.impl.template.__GT_t_reagent$impl$template39621 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template39621(opts__$1,id__$1,fn_to_element__$1,meta39622){
return (new reagent.impl.template.t_reagent$impl$template39621(opts__$1,id__$1,fn_to_element__$1,meta39622));
});

}

return (new reagent.impl.template.t_reagent$impl$template39621(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
