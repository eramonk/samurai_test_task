...
var G__6361 = o;
goog.object.set(G__6361,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
var G__6365 = o;
goog.object.set(G__6365,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
var G__6369 = props;
var G__6369__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6369,cljs.core.cst$kw$id,id):G__6369);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6369__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__4126__auto__ = cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__6370 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__6370,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__6370;
}
})(),id_class);
...
var G__6371 = (cljs.core.count(argv) - first_child);
switch (G__6371) {
case (0):
...
break;
case (1):
var G__6372 = component;
var G__6373 = jsprops;
var G__6374 = reagent.impl.protocols.as_element(this$,cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return reagent.impl.template.global$module$react.createElement(G__6372,G__6373,G__6374);
...
var vec__6376 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6376,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6376,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6376,(2),null);
...
var temp__5739__auto___6379 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___6379 == null)){
} else {
var key_6380 = temp__5739__auto___6379;
(jsprops.key = key_6380);
}
...
var temp__5739__auto___6383 = reagent.impl.util.react_key_from_vec(v);
if((temp__5739__auto___6383 == null)){
} else {
var key_6384 = temp__5739__auto___6383;
(jsprops.key = key_6384);
}

var G__6381 = reagent.impl.component.functional_render_fn(compiler,tag);
var G__6382 = jsprops;
return reagent.impl.template.global$module$react.createElement(G__6381,G__6382);
});
/**
...
var temp__5739__auto___6385 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5739__auto___6385 == null)){
} else {
var key_6386 = temp__5739__auto___6385;
(jsprops.key = key_6386);
}
...
var temp__5739__auto___6387 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___6387 == null)){
} else {
var key_6388 = temp__5739__auto___6387;
(jsprops.key = key_6388);
}
...
var temp__5739__auto___6389 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5739__auto___6389 == null)){
} else {
var key_6390 = temp__5739__auto___6389;
(jsprops.key = key_6390);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6391_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__6391_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__6392 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6392,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6392,(1),null);
...
break;
default:
var G__6397 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
var G__6398 = compiler;
v = G__6397;
compiler = G__6398;
continue;
...
if((typeof reagent !== 'undefined') && (typeof reagent.impl !== 'undefined') && (typeof reagent.impl.template !== 'undefined') && (typeof reagent.impl.template.t_reagent$impl$template6402 !== 'undefined')){
} else {
...
*/
reagent.impl.template.t_reagent$impl$template6402 = (function (opts,id,fn_to_element,meta6403){
this.opts = opts;
this.id = id;
...
(reagent.impl.template.t_reagent$impl$template6402.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_6404,meta6403__$1){
var self__ = this;
var _6404__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template6402(self__.opts,self__.id,self__.fn_to_element,meta6403__$1));
}));

(reagent.impl.template.t_reagent$impl$template6402.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_6404){
var self__ = this;
var _6404__$1 = this;
return self__.meta6403;
}));

(reagent.impl.template.t_reagent$impl$template6402.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template6402.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template6402.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template6402.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template6402.getBasis = (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$sym$opts,cljs.core.cst$sym$id,cljs.core.cst$sym$fn_DASH_to_DASH_element,cljs.core.cst$sym$meta6403], null);
}));

(reagent.impl.template.t_reagent$impl$template6402.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template6402.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template6402");

(reagent.impl.template.t_reagent$impl$template6402.cljs$lang$ctorPrWriter = (function (this__4369__auto__,writer__4370__auto__,opt__4371__auto__){
return cljs.core._write(writer__4370__auto__,"reagent.impl.template/t_reagent$impl$template6402");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template6402.
 */
reagent.impl.template.__GT_t_reagent$impl$template6402 = (function reagent$impl$template$create_compiler_$___GT_t_reagent$impl$template6402(opts__$1,id__$1,fn_to_element__$1,meta6403){
return (new reagent.impl.template.t_reagent$impl$template6402(opts__$1,id__$1,fn_to_element__$1,meta6403));
});

}

return (new reagent.impl.template.t_reagent$impl$template6402(opts,id,fn_to_element,cljs.core.PersistentArrayMap.EMPTY));
});
